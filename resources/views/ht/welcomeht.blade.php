...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="ht/img/1-01x.png" rel="icon" />
    <link href="ht/img/apple-touch-icon.png" rel="apple-touch-icon" />
    ...
    <link href="ht/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

    <!-- Libraries CSS Files -->
    <link href="ht/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet" />
    <link
      href="ht/lib/owlcarousel/assets/owl.theme.default.min.css"
      rel="stylesheet"
    />
    <link href="ht/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <link href="ht/lib/animate/animate.min.css" rel="stylesheet" />
    <link href="ht/lib/modal-video/css/modal-video.min.css" rel="stylesheet" />
    ...
    <header id="header" class="header header-hide">
      <div class="container">
        <div id="logo" class="pull-left">
          <h1>
            <a href="#body"><span>Hyper</span><span style="color: #ECC331">Taxi</span></a>
          </h1>          
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 col-lg-3">
            <img src="ht/img/about-img.png" alt="About" />
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="ht/img/svg/1.png" alt="img" class="img-fluid" />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="ht/img/svg/2.png" alt="img" class="img-fluid" />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="ht/img/svg/3.png" alt="img" class="img-fluid" />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="ht/img/svg/4.png" alt="img" class="img-fluid" />
          ...
          <div class="col-md-6 col-lg-4">
            <div class="feature-block">
              <img src="ht/img/svg/5.png" alt="img" class="img-fluid" />
          ...
          <div class="col-md-6 col-lg-4">
            <div class="feature-block">
              <img src="ht/img/svg/7.png" alt="img" class="img-fluid" />
    ...
    <section id="screenshots" class="padd-section text-center wow fadeInUp">
      ...
      <div class="container">
        <div class="owl-carousel owl-theme">
          ...
          <div><img src="ht/img/screen/7.png" alt="img" /></div>
          <div><img src="ht/img/screen/8.png" alt="img" /></div>
          <div><img src="ht/img/screen/9.png" alt="img" /></div>
          <div><img src="ht/img/screen/10.png" alt="img" /></div>
          <div><img src="ht/img/screen/11.png" alt="img" /></div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-6 col-md-4 col-lg-3">
            <div class="team-block bottom">
              <img src="ht/img/team/1.jpg" class="img-responsive" alt="img" />
          ...
          <div class="col-md-6 col-md-4 col-lg-3">
            <div class="team-block bottom">
              <img src="ht/img/team/2.jpg" class="img-responsive" alt="img" />
              <div class="team-content">
                <ul class="list-unstyled">
                  <li>
                    <a href="#"><i class="fa fa-facebook"></i></a>
          ...
          <div class="col-md-6 col-md-4 col-lg-3">
            <div class="team-block bottom">
              <img src="ht/img/team/3.jpg" class="img-responsive" alt="img" />
              <div class="team-content">
                <ul class="list-unstyled">
                  <li>
                    <a href="#"><i class="fa fa-facebook"></i></a>
          ...
          <div class="col-md-6 col-md-4 col-lg-3">
            <div class="team-block bottom">
              <img src="ht/img/team/4.jpg" class="img-responsive" alt="img" />
              <div class="team-content">
                <ul class="list-unstyled">
                  <li>
                    <a href="#"><i class="fa fa-facebook"></i></a>
  ...
  ============================-->
        ...
        <div class="row">
          <div class="col-md-12 col-lg-4">
            <div class="footer-logo">
                <h1>
                    <a href="#body"><span style="color:#fff">Hyper</span><span style="color: #ECC331">Taxi</span></a>
                </h1>
    ...
    <script src="ht/lib/jquery/jquery.min.js"></script>
    <script src="ht/lib/jquery/jquery-migrate.min.js"></script>
    <script src="ht/lib/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="ht/lib/superfish/hoverIntent.js"></script>
    <script src="ht/lib/superfish/superfish.min.js"></script>
    <script src="ht/lib/easing/easing.min.js"></script>
    <script src="ht/lib/modal-video/js/modal-video.js"></script>
    <script src="ht/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="ht/lib/wow/wow.min.js"></script>
    <!-- Contact Form JavaScript File -->
    <script src="ht/contactform/contactform.js"></script>

    <!-- Template Main Javascript File -->
    <script src="ht/js/main.js"></script>
  </body>
</html>
